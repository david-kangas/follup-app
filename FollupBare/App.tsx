...
card: { 
  ...
  borderWidth: 1,
  borderColor: '#D8D1C5',
  minHeight: 120,   // was 170
  justifyContent: 'center'
},
  activeCard: { borderColor: '#244C5A', borderWidth: 2, backgroundColor: '#FFF' },
  cardName: { fontSize: 24, fontWeight: '800', color: '#1F2933', lineHeight: 32 },
  ...
  primaryActionRow: { flexDirection: 'row', gap: 12, marginTop: 5, marginBottom: 8 },
  btnTeal: {
    backgroundColor: '#244C5A',
    paddingVertical: 10,
...
divider: {
  ...
  unitRow: { flexDirection: 'row', gap: 6, marginBottom: 6 },
  unitBtn: {
    flex: 1,
    alignItems: 'center',
    justifyContent: 'center',
  ...
  valRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 5 },
valBtn: {
  paddingVertical: 8,
  ...
  cancelBtn: { marginTop: 8, padding: 4 },
